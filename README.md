...
## What is tapyrus-core

[chaintope/tapyrus-core](https://github.com/chaintope/tapyrus-core)
...
```bash
$ docker run hawyasunaga/tapyrus-core:v0.4.0 tapyrus-genesis -dev -signblockpubkey=03af80b90d25145da28c583359beb47b21796b2fe1a23c1511e443e7a64dfdb27d -signblockprivatekey=cUJN5RVzYWFoeY8rUztd47jzXCu1p57Ay8V7pqCzsBD3PEXN7Dd4
...
```bash
$ docker run -d -v /my/tapyrus.conf:/etc/tapyrus/tapyrus.conf -e GENESIS_BLOCK_WITH_SIG='00000...00000' hawyasunaga/tapyrus-core:v0.4.0
```
